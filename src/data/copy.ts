// Bilingual copy. Each block has DE + EN.
// TODO: replace the EN bio with the official English version from the previous site.
...
Swallow’s Rose are back — with the new album “The Beginning”. After their scene-celebrated “Downfall” (SBÄM Records), tours and festival shows alongside Dropkick Murphys, Flogging Molly and Less Than Jake, the third album follows a three-year break — this time on Uncle M Music. Out March 2026.`,
  ...
  music: {
    ...
    headlineEN: 'Music',
    spotifyConsentDE:
      'Klick zum Laden des Spotify-Players. Beim Laden werden Daten an Spotify übertragen.',
    spotifyConsentEN:
      'Click to load the Spotify player. Loading sends data to Spotify.',
    spotifyLoadDE: 'Spotify-Player laden',
    spotifyLoadEN: 'Load Spotify player',
    otherDE: 'Auch verfügbar auf',
    otherEN: 'Also available on',
  },
  tour: {
    headlineDE: 'Tour',
    headlineEN: 'Tour',
    ...
    emptyEN: 'Dates announced soon.',
  },
  merch: {
    headlineDE: 'Merch',
    headlineEN: 'Merch',
    bodyDE: 'Shirts, Vinyl und mehr – direkt im offiziellen Uncle-M-Shop.',
    bodyEN: 'Shirts, vinyl and more — straight from the official Uncle M shop.',
    ctaDE: 'Zum Shop',
    ctaEN: 'Visit shop',
  },
  contact: {
    headlineDE: 'Kontakt',
    headlineEN: 'Contact',
    bookingDE: 'Booking & Anfragen',
    bookingEN: 'Booking & inquiries',
    followDE: 'Folgen',
    followEN: 'Follow',
    legalDE: 'Rechtliches',
    legalEN: 'Legal',
